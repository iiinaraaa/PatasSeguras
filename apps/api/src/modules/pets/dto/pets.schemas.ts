...
export const createPetSchema = z.object({
  ...
  city: z.string().min(1, 'Cidade é obrigatória').max(80),
  ...
  photoUrl: z.string().min(1, 'Foto é obrigatória').url('URL de foto inválida'),
  contactPhone: z.string().min(1, 'Telefone de contato é obrigatório').max(20),
